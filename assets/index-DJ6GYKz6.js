function nf(e,n){for(var t=0;t<n.length;t++){const r=n[t];if(typeof r!="string"&&!Array.isArray(r)){for(const l in r)if(l!=="default"&&!(l in e)){const i=Object.getOwnPropertyDescriptor(r,l);i&&Object.defineProperty(e,l,i.get?i:{enumerable:!0,get:()=>r[l]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const i of l)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const i={};return l.integrity&&(i.integrity=l.integrity),l.referrerPolicy&&(i.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?i.credentials="include":l.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(l){if(l.ep)return;l.ep=!0;const i=t(l);fetch(l.href,i)}})();const tf="modulepreload",rf=function(e){return"/"+e},Lo={},lf=function(n,t,r){let l=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),u=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));l=Promise.allSettled(t.map(a=>{if(a=rf(a),a in Lo)return;Lo[a]=!0;const c=a.endsWith(".css"),m=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${m}`))return;const $=document.createElement("link");if($.rel=c?"stylesheet":tf,c||($.as="script"),$.crossOrigin="",$.href=a,u&&$.setAttribute("nonce",u),document.head.appendChild($),c)return new Promise((p,_)=>{$.addEventListener("load",p),$.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${a}`)))})}))}function i(o){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=o,window.dispatchEvent(u),!u.defaultPrevented)throw o}return l.then(o=>{for(const u of o||[])u.status==="rejected"&&i(u.reason);return n().catch(i)})};var I$=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function of(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ku={exports:{}},Jr={},Yu={exports:{}},R={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(w,x){var P=w.length;w.push(x);e:for(;0<P;){var H=P-1>>>1,Y=w[H];if(0<l(Y,x))w[H]=x,w[P]=Y,P=H;else break e}}function t(w){return w.length===0?null:w[0]}function r(w){if(w.length===0)return null;var x=w[0],P=w.pop();if(P!==x){w[0]=P;e:for(var H=0,Y=w.length,Zt=Y>>>1;H<Zt;){var mn=2*(H+1)-1,hl=w[mn],vn=mn+1,Jt=w[vn];if(0>l(hl,P))vn<Y&&0>l(Jt,hl)?(w[H]=Jt,w[vn]=P,H=vn):(w[H]=hl,w[mn]=P,H=mn);else if(vn<Y&&0>l(Jt,P))w[H]=Jt,w[vn]=P,H=vn;else break e}}return x}function l(w,x){var P=w.sortIndex-x.sortIndex;return P!==0?P:w.id-x.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,u=o.now();e.unstable_now=function(){return o.now()-u}}var a=[],c=[],m=1,$=null,p=3,_=!1,y=!1,g=!1,D=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(w){for(var x=t(c);x!==null;){if(x.callback===null)r(c);else if(x.startTime<=w)r(c),x.sortIndex=x.expirationTime,n(a,x);else break;x=t(c)}}function v(w){if(g=!1,d(w),!y)if(t(a)!==null)y=!0,ml(z);else{var x=t(c);x!==null&&vl(v,x.startTime-w)}}function z(w,x){y=!1,g&&(g=!1,f(C),C=-1),_=!0;var P=p;try{for(d(x),$=t(a);$!==null&&(!($.expirationTime>x)||w&&!Ee());){var H=$.callback;if(typeof H=="function"){$.callback=null,p=$.priorityLevel;var Y=H($.expirationTime<=x);x=e.unstable_now(),typeof Y=="function"?$.callback=Y:$===t(a)&&r(a),d(x)}else r(a);$=t(a)}if($!==null)var Zt=!0;else{var mn=t(c);mn!==null&&vl(v,mn.startTime-x),Zt=!1}return Zt}finally{$=null,p=P,_=!1}}var k=!1,E=null,C=-1,V=5,N=-1;function Ee(){return!(e.unstable_now()-N<V)}function ot(){if(E!==null){var w=e.unstable_now();N=w;var x=!0;try{x=E(!0,w)}finally{x?ut():(k=!1,E=null)}}else k=!1}var ut;if(typeof s=="function")ut=function(){s(ot)};else if(typeof MessageChannel<"u"){var Do=new MessageChannel,ef=Do.port2;Do.port1.onmessage=ot,ut=function(){ef.postMessage(null)}}else ut=function(){D(ot,0)};function ml(w){E=w,k||(k=!0,ut())}function vl(w,x){C=D(function(){w(e.unstable_now())},x)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(w){w.callback=null},e.unstable_continueExecution=function(){y||_||(y=!0,ml(z))},e.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<w?Math.floor(1e3/w):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return t(a)},e.unstable_next=function(w){switch(p){case 1:case 2:case 3:var x=3;break;default:x=p}var P=p;p=x;try{return w()}finally{p=P}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(w,x){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var P=p;p=w;try{return x()}finally{p=P}},e.unstable_scheduleCallback=function(w,x,P){var H=e.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?H+P:H):P=H,w){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=P+Y,w={id:m++,callback:x,priorityLevel:w,startTime:P,expirationTime:Y,sortIndex:-1},P>H?(w.sortIndex=P,n(c,w),t(a)===null&&w===t(c)&&(g?(f(C),C=-1):g=!0,vl(v,P-H))):(w.sortIndex=Y,n(a,w),y||_||(y=!0,ml(z))),w},e.unstable_shouldYield=Ee,e.unstable_wrapCallback=function(w){var x=p;return function(){var P=p;p=x;try{return w.apply(this,arguments)}finally{p=P}}}})(ua);oa.exports=ua;var Pf=oa.exports;/**
 * @license React
...
$$\\theta _ { b } = \\arctan \\sqrt { \\frac { \\varepsilon _ { 2 } } { \\varepsilon _ { 1 } } }$$`,w$=`---
id: 均匀平面电磁波的传播特性
title: 均匀平面电磁波的传播特性
order: 1
---
...
$$a\\cos\\theta - b\\sin\\theta = \\sqrt{a^2 + b^2} \\cos(\\theta + \\varphi),\\ \\tan\\varphi = \\frac{b}{a}$$`,E$=`---
id: 导电媒质
title: 导电煤质中的电磁波
order: 5
---
...
定义位移电流
$$\\vec{J}_{e} = \\frac{\\partial \\vec{D}}{\\partial t}$$`,x$=`---
...
$$\\int _ { V } \\nabla \\cdot \\vec { A } ( \\vec { r } ) d V = \\oint _ { S } \\vec { A } ( \\vec { r } ) \\cdot d \\vec{S}$$`,N$=`---
id: helmholtz
title: 亥姆霍兹定理
order: 3
---
...
$\\int_{0}^{x} S(x)dx=\\sum\\limits_{n=0}^{\\infty}\\int_{0}^{x}(a_n x^{n})dx=\\sum\\limits_{n=0}^{\\infty} \\frac{a_n}{n+1} x^{n+1}$`,O$=e=>{const n=/^---\r?\n([\s\S]*?)\r?\n---/,t=e.match(n);if(!t)return{attributes:{},body:e};const r=t[1],l=e.replace(n,"").trim(),i={};return r.split(`
`).forEach(o=>{const u=o.split(":");if(u.length>=2){const a=u[0].trim(),c=u.slice(1).join(":").trim();c==="true"?i[a]=!0:c==="false"?i[a]=!1:!isNaN(Number(c))&&c!==""?i[a]=Number(c):i[a]=c}}),{attributes:i,body:l}},Wu=Object.assign({"../contents/comm-princ/meta.json":Lp,"../contents/comm-princ/总内容/meta.json":Mp,"../contents/comp-anal/integrals/meta.json":Fp,"../contents/comp-anal/meta.json":Ip,"../contents/comp-anal/residue/meta.json":Vp,"../contents/comp-anal/series/meta.json":Qp,"../contents/dsp/dsp-1/meta.json":qp,"../contents/dsp/meta.json":Yp,"../contents/em-fields/e-fields-anal/meta.json":Gp,"../contents/em-fields/meta.json":Jp,"../contents/em-fields/second-part/meta.json":e$,"../contents/em-fields/time-varying-fields/meta.json":t$,"../contents/em-fields/vector-analysis/meta.json":l$,"../contents/math/calc-1/meta.json":o$,"../contents/math/calc-2/meta.json":a$,"../contents/math/meta.json":c$,"../contents/math/series/meta.json":d$}),qu=Object.assign({"../contents/comm-princ/总内容/总内容.md":p$,"../contents/comp-anal/integrals/high-order-derivatives.md":$$,"../contents/comp-anal/residue/isolated-singularity.md":m$,"../contents/comp-anal/series/laurent.md":v$,"../contents/comp-anal/series/taylor.md":h$,"../contents/dsp/dsp-1/discrete-signals.md":_$,"../contents/em-fields/e-fields-anal/basic-equations.md":y$,"../contents/em-fields/e-fields-anal/p-d.md":g$,"../contents/em-fields/second-part/三平.md":z$,"../contents/em-fields/second-part/全反射和全透射.md":S$,"../contents/em-fields/second-part/均匀平面电磁波的传播特性.md":w$,"../contents/em-fields/second-part/垂直入射.md":k$,"../contents/em-fields/second-part/导电媒质.md":E$,"../contents/em-fields/time-varying-fields/faraday-law.md":C$,"../contents/em-fields/time-varying-fields/maxwell-equations.md":x$,"../contents/em-fields/vector-analysis/circulation-curl.md":P$,"../contents/em-fields/vector-analysis/flux-divergence.md":R$,"../contents/em-fields/vector-analysis/helmholtz.md":N$,"../contents/math/calc-1/continuity.md":T$,"../contents/math/calc-1/limits.md":j$,"../contents/math/calc-2/derivatives.md":D$,"../contents/math/series/normal.md":L$}),M$=()=>{try{const e=[],n={},t=new Map,r=o=>{if(!t.has(o)){const u=`../contents/${o}/meta.json`,a=Wu[u]||{};t.set(o,{id:a.id||o,title:a.title||o,order:a.order||999,chapters:[],_chaptersMap:new Map})}return t.get(o)},l=(o,u)=>{if(!o._chaptersMap.has(u)){const a=`../contents/${o.id}/${u}/meta.json`,c=Wu[a]||{},m=u.match(/^(\d+)/),$=m?parseInt(m[1],10):999,p={id:c.id||u,title:c.title||u,order:c.order!==void 0?c.order:$,notes:[]};o._chaptersMap.set(u,p),o.chapters.push(p)}return o._chaptersMap.get(u)};return Object.keys(qu).forEach(o=>{try{const u=o.split("/");if(u.length===5){const a=u[2],c=u[3],m=u[4],$=qu[o],p=r(a),_=l(p,c),y=typeof $=="string"?$:"",{attributes:g,body:D}=O$(y),f=m.replace(".md",""),s=f.match(/^(\d+)/),d=s?parseInt(s[1],10):999,v=g.id||f,z=g.order!==void 0?g.order:d,k=g.title||f;_.notes.push({id:v,title:k,order:z});const E=`${a}/${c}/${v}`;n[E]=D}}catch(u){console.warn("Skipping file due to error:",o,u)}}),{catalog:Array.from(t.values()).sort((o,u)=>o.order-u.order).map(o=>(o.chapters.sort((u,a)=>u.order-a.order),o.chapters.forEach(u=>{u.notes.sort((a,c)=>a.order-c.order)}),delete o._chaptersMap,o)),notesContent:n}}catch(e){return console.error("Critical error in loadCatalog:",e),{catalog:[{id:"error",title:"Loading Error",chapters:[]}],notesContent:{}}}},{catalog:A$,notesContent:F$}=M$(),V$=A$,H$=F$,jo=(e,n="Startup Error")=>{document.body.innerHTML=`
        <div style="
            color: #d8000c; 
