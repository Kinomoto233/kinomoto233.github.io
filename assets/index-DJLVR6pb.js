...
`).forEach(o=>{const a=o.split(":");if(a.length>=2){const u=a[0].trim(),c=a.slice(1).join(":").trim();c==="true"?i[u]=!0:c==="false"?i[u]=!1:!isNaN(Number(c))&&c!==""?i[u]=Number(c):i[u]=c}}),{attributes:i,body:l}},qa=Object.assign({"../contents/comm-princ/meta.json":d$,"../contents/comm-princ/总内容/meta.json":$$,"../contents/dsp/dsp-1/meta.json":_$,"../contents/dsp/meta.json":h$,"../contents/dsp/总/meta.json":g$,"../contents/em-fields/e-fields-anal/meta.json":S$,"../contents/em-fields/meta.json":k$,"../contents/em-fields/second-part/meta.json":C$,"../contents/em-fields/time-varying-fields/meta.json":P$,"../contents/em-fields/vector-analysis/meta.json":T$,"../contents/math/calc-1/meta.json":j$,"../contents/math/calc-2/meta.json":L$,"../contents/math/meta.json":O$,"../contents/math/series/meta.json":A$,"../contents/复变函数/integrals/meta.json":H$,"../contents/复变函数/meta.json":U$,"../contents/复变函数/residue/meta.json":Q$,"../contents/复变函数/series/meta.json":G$,"../contents/复变函数/记忆点/meta.json":K$,"../contents/数字图像处理/meta.json":Y$,"../contents/数字图像处理/第0章-说明/meta.json":Z$,"../contents/数字图像处理/第1章-绪论/meta.json":nm,"../contents/数字图像处理/第2章-基础知识/meta.json":tm,"../contents/数字图像处理/第3章-图像增强/meta.json":lm,"../contents/数字图像处理/第4章-图像变换/meta.json":om,"../contents/数字图像处理/第5章-图像复原/meta.json":um,"../contents/数字图像处理/第6章-图像分割/meta.json":cm,"../contents/数字图像处理/第7章-图像压缩/meta.json":dm}),Ga=Object.assign({"../contents/comm-princ/总内容/总内容.md":pm,"../contents/dsp/dsp-1/discrete-signals.md":$m,"../contents/dsp/总/总内容.md":mm,"../contents/em-fields/e-fields-anal/basic-equations.md":_m,"../contents/em-fields/e-fields-anal/p-d.md":vm,"../contents/em-fields/second-part/三平.md":hm,"../contents/em-fields/second-part/全反射和全透射.md":ym,"../contents/em-fields/second-part/均匀平面电磁波的传播特性.md":gm,"../contents/em-fields/second-part/垂直入射.md":zm,"../contents/em-fields/second-part/导电媒质.md":Sm,"../contents/em-fields/time-varying-fields/faraday-law.md":wm,"../contents/em-fields/time-varying-fields/maxwell-equations.md":km,"../contents/em-fields/vector-analysis/circulation-curl.md":xm,"../contents/em-fields/vector-analysis/flux-divergence.md":Cm,"../contents/em-fields/vector-analysis/helmholtz.md":Em,"../contents/math/calc-1/continuity.md":Pm,"../contents/math/calc-1/limits.md":Rm,"../contents/math/calc-2/derivatives.md":Tm,"../contents/math/series/normal.md":Nm,"../contents/复变函数/integrals/high-order-derivatives.md":jm,"../contents/复变函数/residue/isolated-singularity.md":Dm,"../contents/复变函数/series/laurent.md":Lm,"../contents/复变函数/series/taylor.md":Mm,"../contents/复变函数/记忆点/记忆点.md":Om,"../contents/数字图像处理/第0章-说明/00-考试重点与猜题清单.md":Bm,"../contents/数字图像处理/第1章-绪论/00-考试重点与猜题清单.md":Am,"../contents/数字图像处理/第1章-绪论/1.1-数字图像.md":Fm,"../contents/数字图像处理/第1章-绪论/1.2-数字图像处理.md":Hm,"../contents/数字图像处理/第1章-绪论/1.3-相关学科和领域.md":Im,"../contents/数字图像处理/第1章-绪论/1.4-应用与发展趋势.md":Um,"../contents/数字图像处理/第2章-基础知识/2.1-图像数字化.md":Vm,"../contents/数字图像处理/第2章-基础知识/2.2-图像数据结构与彩色空间.md":Qm,"../contents/数字图像处理/第2章-基础知识/2.3-图像文件格式.md":qm,"../contents/数字图像处理/第2章-基础知识/2.4-图像质量评价.md":Gm,"../contents/数字图像处理/第3章-图像增强/3.1-引言.md":Wm,"../contents/数字图像处理/第3章-图像增强/3.2-直接灰度变换.md":Km,"../contents/数字图像处理/第3章-图像增强/3.3-直方图修正与均衡化.md":Xm,"../contents/数字图像处理/第3章-图像增强/3.4-图像平滑与统计滤波.md":Ym,"../contents/数字图像处理/第3章-图像增强/3.5-图像锐化.md":Jm,"../contents/数字图像处理/第4章-图像变换/4.1-傅里叶变换.md":Zm,"../contents/数字图像处理/第4章-图像变换/4.2-离散余弦变换.md":bm,"../contents/数字图像处理/第4章-图像变换/4.3-小波变换及应用.md":n1,"../contents/数字图像处理/第5章-图像复原/5.1-图像复原的基本概念.md":e1,"../contents/数字图像处理/第5章-图像复原/5.2-图像退化模型.md":t1,"../contents/数字图像处理/第5章-图像复原/5.3-图像复原方法.md":r1,"../contents/数字图像处理/第5章-图像复原/5.4-图像几何校正.md":l1,"../contents/数字图像处理/第6章-图像分割/6.1-边缘检测.md":i1,"../contents/数字图像处理/第6章-图像分割/6.2-Hough变换.md":o1,"../contents/数字图像处理/第6章-图像分割/6.3-阈值分割与Otsu.md":a1,"../contents/数字图像处理/第6章-图像分割/6.4-区域分割与图割.md":u1,"../contents/数字图像处理/第6章-图像分割/6.5-形态学与开闭运算.md":s1,"../contents/数字图像处理/第6章-图像分割/6.6-FCN全卷积神经网络.md":c1,"../contents/数字图像处理/第7章-图像压缩/7.1-图像压缩背景.md":f1,"../contents/数字图像处理/第7章-图像压缩/7.2-霍夫曼编码与信息熵.md":d1,"../contents/数字图像处理/第7章-图像压缩/7.3-像素预测.md":p1,"../contents/数字图像处理/第7章-图像压缩/7.4-行程编码.md":$1}),_1=()=>{try{const n=[],e={},t=new Map,r=o=>{if(!t.has(o)){const a=`../contents/${o}/meta.json`,u=qa[a]||{};t.set(o,{id:u.id||o,title:u.title||o,order:u.order||999,chapters:[],_chaptersMap:new Map})}return t.get(o)},l=(o,a)=>{if(!o._chaptersMap.has(a)){const u=`../contents/${o.id}/${a}/meta.json`,c=qa[u]||{},m=a.match(/^(\d+)/),$=m?parseInt(m[1],10):999,p={id:c.id||a,title:c.title||a,order:c.order!==void 0?c.order:$,notes:[]};o._chaptersMap.set(a,p),o.chapters.push(p)}return o._chaptersMap.get(a)};return Object.keys(Ga).forEach(o=>{try{const a=o.split("/");if(a.length===5){const u=a[2],c=a[3],m=a[4],$=Ga[o],p=r(u),h=l(p,c),y=typeof $=="string"?$:"",{attributes:g,body:D}=m1(y),f=m.replace(".md",""),s=f.match(/^(\d+)/),d=s?parseInt(s[1],10):999,_=g.id||f,z=g.order!==void 0?g.order:d,k=g.title||f;h.notes.push({id:_,title:k,order:z});const x=`${u}/${c}/${_}`;e[x]=D}}catch(a){console.warn("Skipping file due to error:",o,a)}}),{catalog:Array.from(t.values()).sort((o,a)=>o.order-a.order).map(o=>(o.chapters.sort((a,u)=>a.order-u.order),o.chapters.forEach(a=>{a.notes.sort((u,c)=>u.order-c.order)}),delete o._chaptersMap,o)),notesContent:e}}catch(n){return console.error("Critical error in loadCatalog:",n),{catalog:[{id:"error",title:"Loading Error",chapters:[]}],notesContent:{}}}},{catalog:v1,notesContent:h1}=_1(),S1=v1,w1=h1,jo=(n,e="Startup Error")=>{document.body.innerHTML=`
        <div style="
            color: #d8000c; 
...
${n.stack||""}</pre>
    ...
    `},y1=async()=>{try{const{default:n}=await Bf(async()=>{const{default:t}=await import("./App-CXtYvrHs.js");return{default:t}},[]);Ql.createRoot(document.getElementById("root")).render(Ao.jsx(ru.StrictMode,{children:Ao.jsx(n,{})}))}catch(n){jo(n)}};window.addEventListener("error",n=>jo(n.error||n.message,"Runtime Error"));window.addEventListener("unhandledrejection",n=>jo(n.reason,"Promise Rejection"));y1();export{z1 as R,g1 as a,S1 as c,Af as g,Ao as j,w1 as n,br as r};
