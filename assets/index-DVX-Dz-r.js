...
${n.stack||""}</pre>
    ...
    `},y1=async()=>{try{const{default:n}=await Bf(async()=>{const{default:t}=await import("./App-QciWUEgU.js");return{default:t}},[]);Ql.createRoot(document.getElementById("root")).render(Ao.jsx(ru.StrictMode,{children:Ao.jsx(n,{})}))}catch(n){jo(n)}};window.addEventListener("error",n=>jo(n.error||n.message,"Runtime Error"));window.addEventListener("unhandledrejection",n=>jo(n.reason,"Promise Rejection"));y1();export{z1 as R,g1 as a,S1 as c,Af as g,Ao as j,w1 as n,br as r};
