...
$\\int_{0}^{x} S(x)dx=\\sum\\limits_{n=0}^{\\infty}\\int_{0}^{x}(a_n x^{n})dx=\\sum\\limits_{n=0}^{\\infty} \\frac{a_n}{n+1} x^{n+1}$`,D$=e=>{const n=/^---\r?\n([\s\S]*?)\r?\n---/,t=e.match(n);if(!t)return{attributes:{},body:e};const r=t[1],l=e.replace(n,"").trim(),i={};return r.split(`
`).forEach(o=>{const u=o.split(":");if(u.length>=2){const a=u[0].trim(),c=u.slice(1).join(":").trim();c==="true"?i[a]=!0:c==="false"?i[a]=!1:!isNaN(Number(c))&&c!==""?i[a]=Number(c):i[a]=c}}),{attributes:i,body:l}},Wu=Object.assign({"../contents/comm-princ/meta.json":jp,"../contents/comm-princ/总内容/meta.json":Mp,"../contents/comp-anal/integrals/meta.json":Fp,"../contents/comp-anal/meta.json":Bp,"../contents/comp-anal/residue/meta.json":Vp,"../contents/comp-anal/series/meta.json":Qp,"../contents/dsp/dsp-1/meta.json":qp,"../contents/dsp/meta.json":Yp,"../contents/em-fields/e-fields-anal/meta.json":Gp,"../contents/em-fields/meta.json":Jp,"../contents/em-fields/second-part/meta.json":e$,"../contents/em-fields/time-varying-fields/meta.json":t$,"../contents/em-fields/vector-analysis/meta.json":l$,"../contents/math/calc-1/meta.json":o$,"../contents/math/calc-2/meta.json":a$,"../contents/math/meta.json":c$,"../contents/math/series/meta.json":d$}),qu=Object.assign({"../contents/comm-princ/总内容/总内容.md":p$,"../contents/comp-anal/integrals/high-order-derivatives.md":$$,"../contents/comp-anal/residue/isolated-singularity.md":m$,"../contents/comp-anal/series/laurent.md":v$,"../contents/comp-anal/series/taylor.md":h$,"../contents/dsp/dsp-1/discrete-signals.md":y$,"../contents/em-fields/e-fields-anal/basic-equations.md":_$,"../contents/em-fields/e-fields-anal/p-d.md":g$,"../contents/em-fields/second-part/三平.md":z$,"../contents/em-fields/second-part/全反射和全透射.md":S$,"../contents/em-fields/second-part/均匀平面电磁波的传播特性.md":w$,"../contents/em-fields/second-part/垂直入射.md":k$,"../contents/em-fields/second-part/导电媒质.md":E$,"../contents/em-fields/time-varying-fields/faraday-law.md":C$,"../contents/em-fields/time-varying-fields/maxwell-equations.md":x$,"../contents/em-fields/vector-analysis/circulation-curl.md":P$,"../contents/em-fields/vector-analysis/flux-divergence.md":R$,"../contents/em-fields/vector-analysis/helmholtz.md":N$,"../contents/math/calc-1/continuity.md":T$,"../contents/math/calc-1/limits.md":L$,"../contents/math/calc-2/derivatives.md":O$,"../contents/math/series/normal.md":j$}),M$=()=>{try{const e=[],n={},t=new Map,r=o=>{if(!t.has(o)){const u=`../contents/${o}/meta.json`,a=Wu[u]||{};t.set(o,{id:a.id||o,title:a.title||o,order:a.order||999,chapters:[],_chaptersMap:new Map})}return t.get(o)},l=(o,u)=>{if(!o._chaptersMap.has(u)){const a=`../contents/${o.id}/${u}/meta.json`,c=Wu[a]||{},m=u.match(/^(\d+)/),$=m?parseInt(m[1],10):999,p={id:c.id||u,title:c.title||u,order:c.order!==void 0?c.order:$,notes:[]};o._chaptersMap.set(u,p),o.chapters.push(p)}return o._chaptersMap.get(u)};return Object.keys(qu).forEach(o=>{try{const u=o.split("/");if(u.length===5){const a=u[2],c=u[3],m=u[4],$=qu[o],p=r(a),y=l(p,c),_=typeof $=="string"?$:"",{attributes:g,body:O}=D$(_),f=m.replace(".md",""),s=f.match(/^(\d+)/),d=s?parseInt(s[1],10):999,v=g.id||f,z=g.order!==void 0?g.order:d,k=g.title||f;y.notes.push({id:v,title:k,order:z});const E=`${a}/${c}/${v}`;n[E]=O}}catch(u){console.warn("Skipping file due to error:",o,u)}}),{catalog:Array.from(t.values()).sort((o,u)=>o.order-u.order).map(o=>(o.chapters.sort((u,a)=>u.order-a.order),o.chapters.forEach(u=>{u.notes.sort((a,c)=>a.order-c.order)}),delete o._chaptersMap,o)),notesContent:n}}catch(e){return console.error("Critical error in loadCatalog:",e),{catalog:[{id:"error",title:"Loading Error",chapters:[]}],notesContent:{}}}},{catalog:A$,notesContent:F$}=M$(),V$=A$,H$=F$,Lo=(e,n="Startup Error")=>{document.body.innerHTML=`
        <div style="
            color: #d8000c; 
